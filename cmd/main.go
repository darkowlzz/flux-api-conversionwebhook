...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c85bce8b.toolkit.fluxcd.io",
	...
	if err = (&sourcev1.GitRepository{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "GitRepository")
		os.Exit(1)
	}
	if err = (&sourcev1beta2.GitRepository{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "GitRepository")
		os.Exit(1)
	}
	...
	if err = (&kustomizev1.Kustomization{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "Kustomization")
		os.Exit(1)
	}
	if err = (&kustomizev1beta2.Kustomization{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "Kustomization")
		os.Exit(1)
	}
